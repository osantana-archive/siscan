...
CLEAR
TEXT  
 ┌────────── ACTIVITIES ────────────┐ ╔═ CURRENT FILES ══╦══ FLOCK STATUS ═══╗
 │  1. USE<file>/CLOSE<file>        │ ║ Data :           ║                   ║
 │  2. SET INDEX                    │ ║ Indx :           ║                   ║
 │  3. FLOCK() current file         │ ║ Usage:           ║                   ║
 │  4. RLOCK() current record       │ ╠═ CURRENT RECORD ═╬══ RLOCK STATUS ═══╣
 │  6. GOTO RECORD                  │ ║                  ║                   ║
 │  5. UNLOCK ALL                   │ ║                  ║                   ║
 └──────────────────────────────────┘ ╚══════════════════╩═══════════════════╝
ENDTEXT
...
ELSE
  ...
  filename = SPACE(8)
ENDIF
@ 1,38 SAY '╔═ CURRENT FILES ══╦══ FLOCK STATUS ═══╗'
DO WHILE choice > 0
