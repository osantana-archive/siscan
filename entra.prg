...
DO WHILE .T.
   ...
   ENDIF
   IF HNUMERO = "0001"
      MESSAGE("Deseja sair do sistema? (ENTER - Sim / Outra Tecla - Näo)")
      IF INKEY(0) = 13
   ...
   DO WHILE .T.
      ...
      ENDIF
      IF BLOQ
         MESSAGE("O Produto Näo está Disponível por Falta no Estoque...")
         INKEY(2)
         MESSAGE()
         LOOP
      ENDIF
      ...
      SELECT LANCAMEN
      SET ORDER TO 1
      MESSAGE("Tecle ENTER Após a Digitaçäo...")
