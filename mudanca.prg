...
DO WHILE .T.
   ...
   SET ORDER TO 2
   GO  TOP
   MOLDURA(12,01,21,76,STDMOLD,.T.,"Alteraçäo de Conta",STDINVE)
   HCODIGO = 0
   @ 13,05 SAY "Entre com o Número:" GET HCODIGO PICTURE "9999"
   SET CURSOR ON
   READ
   SET CURSOR OFF
   ...
   @ 15,03 SAY "Endereço..:" GET XENDERECO PICTURE "@!"
...
*   @ 18,52 SAY "Tipo Pgto.:" GET XTIPOPGTO PICTURE "!" VALID (XTIPOPGTO="S" .OR. XTIPOPGTO="Q" .OR. XTIPOPGTO="M")
   ...
   SEEK XRG
   IF FOUND() .AND. REGTMP <> RECNO()
      MESSAGE("Já existe registro com esse RG...")
      LOOP
   ENDIF
   GO REGTMP
   SETCOLOR(STDINVE)
   ...
   XSENHA    = HSENHA  && Senha do usuário
   XBLOQUEIO = BLOQUEIO
   XCREDITO  = CREDITO
   XSALDOS   = SALDOS
